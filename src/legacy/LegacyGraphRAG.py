...
class LegacyGraphRAG:
    ...
    def __init__(self,
        ...
        Attributes:
            ...
            saving_dir (str): The directory where specific legacy CogitoRAG instances will be stored. This defaults
        ...
        logger.debug(f"CogitoRAG legacy init with config:\n  {_print_config}\n")
        ...
        if self.global_config.openie_mode == 'online':
            self.openie = OpenIE(llm_model=self.llm_model, topic_extraction_mode=self.global_config.topic_extraction_mode)
    ...
    def index(self, docs: List[str]):
        """
        Indexes the given documents using the legacy CogitoRAG-compatible graph pipeline
    ...
    def delete(self, docs_to_delete: List[str]):
        """
        Deletes the given documents from all data structures within the legacy graph pipeline.
    ...
    def retrieve(self,
        ...
        """
        Performs retrieval using the legacy CogitoRAG-compatible pipeline, which consists of several steps:
        - Fact Retrieval
    ...
    def rag_qa(self,
        ...
        """
        Performs retrieval-augmented generation enhanced QA using the legacy CogitoRAG-compatible pipeline.
