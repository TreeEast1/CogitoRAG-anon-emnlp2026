from .ner_v2 import one_shot_ner_paragraph, one_shot_ner_output
...
- Preserve specific factual details (temporal, geographical, numerical information) in the relationships when relevant.
